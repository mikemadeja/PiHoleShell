...
.EXAMPLE
Get-PiHoleDnsBlockingStatus -PiHoleServer "http://pihole.domain.com:8080" -Password "P@$$W0RD"
    #>
...
.EXAMPLE
Set-PiHoleDnsBlocking -PiHoleServer "http://pihole.domain.com:8080" -Password "P@$$W0RD" -Blocking $false -TimeInSeconds 60
    #>
    [CmdletBinding()]
